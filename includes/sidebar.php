    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">ИЗПИТИ</li>
                <li>
                <a href="#">
                ...
                <ul >
                    <?php 
                        ...
                        { ?>
                            <a href="#">
                                <i class="metismenu-icon"></i>Няма изпити
                            </a>
                        <?php }
                     ?>
                 ...
                 <li class="app-sidebar__heading">Взети изпити</li>
                <li>
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">Все още нямате взет изпит</a>
                    <?php }
                ...
                <li class="app-sidebar__heading">ОБРАТНА ВРЪЗКА</li>
                <li>
