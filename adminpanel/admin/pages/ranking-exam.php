<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <?php 
                   ...
                   <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div><b class="text-primary">КЛАСИРАНЕ ПО ИЗПИТ</b><br>
                                Име на изпит: <?php echo $selEx['ex_title']; ?><br><br>
                               <span class="border" style="padding:10px;color:black;background-color: yellow;">Отличен 6</span>
                               <span class="border" style="padding:10px;color:white;background-color: green;">Много добър 5</span>
                               <span class="border" style="padding:10px;color:white;background-color: blue;">Добър 4</span>
                               <span class="border" style="padding:10px;color:white;background-color: red;">Среден 3</span>
                               <span class="border" style="padding:10px;color:black;background-color: #E9ECEE;">Слаб 2</span>
                            </div>
                        </div>
                    </div>
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                          <tbody>
                            <thead>
                                <tr>
                                    <th width="25%">Име и фамилия на курсист</th>
                                    <th>Резултат</th>
                                    <th>Процент</th>
                                </tr>
                            </thead>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div><b>КЛАСИРАНЕ ПО ИЗПИТ</b></div>
                    </div>
                </div>
                </div> 
                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4">Заглавие на изпит</th>
                                <th class="text-left ">Курс</th>
                                <th class="text-left ">Описание</th>
                                <th class="text-center" width="8%">Функция</th>
                            </tr>
                            </thead>
                            <tbody>
                              <?php 
                                    ...
                                    while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                             <a href="?page=ranking-exam&exam_id=<?php echo $selExamRow['ex_id']; ?>"  class="btn btn-success btn-sm">Преглед</a>
                                            </td>
                                        </tr>
